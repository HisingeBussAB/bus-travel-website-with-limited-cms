...
$redirectUri .= $_SERVER['HTTP_HOST'] . '/adminp/oauth-activate/';
...
if (!empty($result['oauth_clientid'])) { $clientId = $result['oauth_clientid']; }
if (!empty($result['oauth_clientsecret'])) { $clientSecret = $result['oauth_clientsecret']; }
//END_MODIFIED
