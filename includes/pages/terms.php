...
<h4>Avbeställningsskydd</h4>
Detta är frivilligt och tillkommer vid bokning med 150:-/person oavsett resans längd. Avbeställningsskyddet gäller inte för särskilda kostnader så som teaterbiljetter, konsertbiljetter, evenemangskostnader mm som ingår i arrangemangspriset. Dessa kostnader måste erläggas vid avbokning. Dessa kostnader måste erläggas vid avbokning.
<h4>Avbeställning med avbeställningsskydd</h4>
Då villkoren för avbeställningsskyddets giltighet är uppfyllda (läkarintyg) debiteras endast expeditionsavgiften enligt ovan = 250:- + avbeställningsskyddet. Se Allmänna villkor som klargör avbeställningsskyddets giltighet.
<h4>Avbeställning utan avbeställningsskydd</h4>
